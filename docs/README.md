...
The `product/` tree is being established now. Until the real product base is written, these files exist to keep repo references and documentation paths accurate.
